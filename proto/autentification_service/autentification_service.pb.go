...
var file_autentification_service_proto_depIdxs = []int32{
	0, // 0: autentification.RegistrationRequest.role:type_name -> autentification.Role
	1, // 1: autentification.AutentificationService.Login:input_type -> autentification.LoginRequest
	3, // 2: autentification.AutentificationService.Registration:input_type -> autentification.RegistrationRequest
	5, // 3: autentification.AutentificationService.ChangePassword:input_type -> autentification.ChangePasswordRequest
	7, // 4: autentification.AutentificationService.ChangeEmail:input_type -> autentification.ChangeEmailRequest
	2, // 5: autentification.AutentificationService.Login:output_type -> autentification.LoginResponse
	4, // 6: autentification.AutentificationService.Registration:output_type -> autentification.RegistrationResponse
	6, // 7: autentification.AutentificationService.ChangePassword:output_type -> autentification.ChangePasswordResponse
	8, // 8: autentification.AutentificationService.ChangeEmail:output_type -> autentification.ChangeEmailResponse
